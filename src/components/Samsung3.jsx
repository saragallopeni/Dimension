...
const Samsung3 = () => {
     ...
     const button = new RoundedBoxGeometry(0.3, 0.2, 0.11, 12, 1);
         ...
         const starsTexture = useLoader(TextureLoader ,stars);
    ...
    return(
        ...
        <mesh geometry={camera} position={[1.5, -0.6, -0.1]}>
            <meshPhongMaterial color={'pink'} shininess={50} specular={'pink'} metalness={1}/>
        </mesh>
